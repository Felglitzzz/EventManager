    ...
    return (
        <div>
            <div className="container-fluid fill_screen img-fluid d-flex align-items-center">
                <div id="carouselExampleSlidesOnly" className="container-fluid carousel slide" data-ride="carousel">
                    ...
                    <div className="d-flex justify-content-center">
                        <a className="btn-resp-height d-flex marg btn border-white btn-outline-orange aconform text-white px-5 " href="#discover" type="button">Explore</a>                  
                    </div>
                </div>
            </div>
        </div>
