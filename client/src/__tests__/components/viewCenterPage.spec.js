...
import EventCenterList from '../../components/Centers/EventCenterList';
...
describe(' View Center\'s Page', () => {
  ...
  xit('should render stateless child component', () => {
    const childProps = {
    ...
    const wrapper = shallow(<EventCenterList {...childProps} />);
    wrapper.setProps({
      centers: {
        count: 13,
        rows: [
